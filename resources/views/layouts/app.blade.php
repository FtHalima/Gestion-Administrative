...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased flex overflow-x-hidden w-full">
        <!-- Sidebar -->
                ...
                <nav class="mt-2 space-y-1 flex-1">
                        ...
                        @if (auth()->user()->role === 'administration')
                            ...
                            <a href="{{ route('utilisateurs.index') }}"
                               class="flex items-center px-3 py-2 rounded-md text-sm font-medium hover:bg-white/10 hover:text-white transition-colors text-[#B6C4FF] {{ request()->routeIs('utilisateurs.index') ? 'bg-[rgba(30,58,138,0.2)] border-l-4 border-white text-white font-bold' : '' }}">
                                <svg class="h-5 w-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path d="M12 12c2.21 0 4-1.79 4-4h-2c0 1.1-.9 2-2 2v3h3c0-1.11-.89-2-2-2s-2-.9-2-2v-3H8c0 2.21 1.79 4 4 4zm6-4h-1c0 2.76-2.24 5-5 5s-5-2.24-5-5h-1c0 3.53 2.86 6.4 6.41 7l.59.16a1 1 0 001.42 0l.59-.16A6.41 6.41 0 0018 12c0-3.53-2.86-6.4-6.41-7zm0 10c-1.1 0-2-.9-2-2h-2c0 1.1.9 2 2 2h2c1.1 0 2-.9 2-2v-2c0-1.1-.9-2-2-2h-2c-1.1 0-2 .9-2 2v2c0 1.1.9 2 2 2h2z"/>
                                </svg>
                                Utilisateurs
                            </a>
                    ...
                    <a href="{{ route('note-examens.index') }}"
                       class="flex items-center px-3 py-2 rounded-md text-sm font-medium hover:bg-white/10 hover:text-white transition-colors text-[#B6C4FF] {{ request()->routeIs('note-examens.index') ? 'bg-[rgba(30,58,138,0.2)] border-l-4 border-white text-white font-bold' : '' }}">
                        <svg class="h-5 w-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m2 0a3 3 0 10-6m-6 6a3 3 0 00-6m6 6a3 3 0 006" />
                        </svg>
                        Notes d'examens
                    </a>
        ...
        <!-- Main Content -->
        <div class="ml-64 min-h-screen bg-gray-100 flex flex-col min-w-0 w-full">
            <!-- Header (white bar) -->
