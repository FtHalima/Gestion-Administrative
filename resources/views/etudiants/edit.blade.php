        ...
        <div class="w-full sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('etudiants.update', $etudiant->ppr) }}">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                                    ...
                                    <div>
                                        ...
                                        <input id="nom_prenom_francais" type="text" name="nom_prenom_francais"
                                               value="{{ old('nom_prenom_francais', $etudiant->nom_prenom_francais) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                    ...
                                    <div>
                                        ...
                                        <input id="nom_prenom_arabe" type="text" name="nom_prenom_arabe"
                                               value="{{ old('nom_prenom_arabe', $etudiant->nom_prenom_arabe) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                    <div>
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                    <div>
                                        ...
                                        <input id="baccalaureat" type="text" name="baccalaureat"
                                               value="{{ old('baccalaureat', $etudiant->baccalaureat) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                    <div>
                                        ...
                                        <input id="direction_baccalaureat" type="text" name="direction_baccalaureat"
                                               value="{{ old('direction_baccalaureat', $etudiant->direction_baccalaureat) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                    <div>
                                        ...
                                        <input id="annee_baccalaureat" type="text" name="annee_baccalaureat"
                                               value="{{ old('annee_baccalaureat', $etudiant->annee_baccalaureat) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                    <div>
                                        ...
                                        <input id="licence" type="text" name="licence"
                                               value="{{ old('licence', $etudiant->licence) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                    <div>
                                        ...
                                        <input id="annee_licence" type="text" name="annee_licence"
                                               value="{{ old('annee_licence', $etudiant->annee_licence) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                    <div>
                                        ...
                                        <input id="universite_licence" type="text" name="universite_licence"
                                               value="{{ old('universite_licence', $etudiant->universite_licence) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                    <div>
                                        ...
                                        <input id="faculte_licence" type="text" name="faculte_licence"
                                               value="{{ old('faculte_licence', $etudiant->faculte_licence) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                    <div>
                                        ...
                                        <input id="autre_diplome" type="text" name="autre_diplome"
                                               value="{{ old('autre_diplome', $etudiant->autre_diplome) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                    <div>
                                        ...
                                        <input id="specialite_diplome" type="text" name="specialite_diplome"
                                               value="{{ old('specialite_diplome', $etudiant->specialite_diplome) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                    <div>
                                        ...
                                        <input id="annee_diplome" type="text" name="annee_diplome"
                                               value="{{ old('annee_diplome', $etudiant->annee_diplome) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                    <div>
                                        ...
                                        <input id="universite_diplome" type="text" name="universite_diplome"
                                               value="{{ old('universite_diplome', $etudiant->universite_diplome) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                    <div>
                                        ...
                                        <input id="faculte_diplome" type="text" name="faculte_diplome"
                                               value="{{ old('faculte_diplome', $etudiant->faculte_diplome) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                    <div>
                                        ...
                                        <input id="centre" type="text" name="centre"
                                               value="{{ old('centre', $etudiant->centre) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                    <div>
                                        ...
                                        <input id="ville_centre" type="text" name="ville_centre"
                                               value="{{ old('ville_centre', $etudiant->ville_centre) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                    <div>
                                        ...
                                        <input id="annee_sortie" type="text" name="annee_sortie"
                                               value="{{ old('annee_sortie', $etudiant->annee_sortie) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                    ...
                                    <div>
                                        ...
                                        <input id="grade" type="text" name="grade"
                                               value="{{ old('grade', $etudiant->grade) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input id="echelon" type="text" name="echelon"
                                               value="{{ old('echelon', $etudiant->echelon) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                    <div>
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <input id="cycle" type="text" name="cycle"
                                               value="{{ old('cycle', $etudiant->cycle) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input id="direction_provinciale" type="text" name="direction_provinciale"
                                               value="{{ old('direction_provinciale', $etudiant->direction_provinciale) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                    <div>
                                        ...
                                        <input id="classe" type="text" name="classe"
                                               value="{{ old('classe', $etudiant->classe) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                    <div>
                                        ...
                                        <input id="n_ordre" type="text" name="n_ordre"
                                               value="{{ old('n_ordre', $etudiant->n_ordre) }}"
                                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                               maxlength="255">
                                    </div>
                                </div>
