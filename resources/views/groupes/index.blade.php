    ...
    <slot name="header">
        <div class="space-y-2">
            ...
            <p class="text-sm text-[#64748B]">
                Liste et gestion des groupes d'étudiants
            </p>
        </div>
    </slot>
                ...
                <div class="px-6 py-4">
                    <div class="mb-4 flex justify-between items-center border-b pb-2">
                        <div class="space-y-1">
                            ...
                            <p class="text-sm text-[#64748B]">
                                Gérez les groupes de votre établissement
                            </p>
                        </div>
                            ...
                            <tbody class="bg-white divide-y divide-[#D5DBE8]">
                                @forelse ($groupes as $groupe)
                                    <tr class="hover:bg-[#EFF6FF] transition-colors">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-[#64748B]">{{ $groupe->nom_groupe }}</td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            <form action="{{ route('groupes.destroy', $groupe) }}" method="POST" class="d-inline">
                                                ...
                                                <button type="submit"
                                                        ...
                                                        onclick="return confirm('���Êtes-vous sûr de vouloir supprimer ce groupe ? Il ne peut être supprimé s'il est lié à des étudiants ou des notes (examen ou module).');">
                                                    Supprimer
                                                </button>
                                            </form>
                                        </td>
